...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class Mod0 {
            ...
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(-121.99 + 180);//61.26);
        ...
        public static final class Mod1 {
            ...
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(-174.023 + 180);//9.14);
            public static final SwerveModuleConstants CONSTANTS = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET, ANGLE_OFFSET_PRACTICE);
        }
        ...
        public static final class Mod2 {
            ...
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(-17.13 + 180);//161.02);
            public static final SwerveModuleConstants CONSTANTS = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET, ANGLE_OFFSET_PRACTICE);
        }
        ...
        public static final class Mod3 {
            ...
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(-70.92 + 180);//112.32);
            public static final SwerveModuleConstants CONSTANTS = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET, ANGLE_OFFSET_PRACTICE);
        }
