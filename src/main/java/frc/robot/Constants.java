...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class Mod0 {
            ...
            public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(-106.44);
        ...
        public static final class Mod1 {
            ...
            public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(-40.61);
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(0);
            public static final SwerveModuleConstants CONSTANTS = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET, ANGLE_OFFSET_PRACTICE);
        }
        ...
        public static final class Mod2 {
            ...
            public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(-37.18);
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(0);
            public static final SwerveModuleConstants CONSTANTS = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET, ANGLE_OFFSET_PRACTICE);
        }
        ...
        public static final class Mod3 {
            ...
            public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(148.8);
            public static final Rotation2d ANGLE_OFFSET_PRACTICE = Rotation2d.fromDegrees(0);
            public static final SwerveModuleConstants CONSTANTS = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET, ANGLE_OFFSET_PRACTICE);
        }
